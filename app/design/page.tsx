...
const TYPE = [
  ['Display', 'text-display font-semibold', '32 / 40 · 600'],
  ['H1', 'text-h1 font-semibold', '24 / 32 · 600'],
  ['H2', 'text-h2 font-semibold', '20 / 28 · 600'],
  ['H3', 'text-h3 font-semibold', '16 / 24 · 600'],
  ['Body', 'text-body', '15 / 24 · 400'],
  ['Small', 'text-small', '13 / 20 · 400'],
  ['Micro', 'text-micro font-medium', '12 / 16 · 500'],
] as const
      ...
      <main className="mx-auto max-w-4xl space-y-10 px-4 py-10 sm:px-6">
        <header>
          ...
          <p className="mt-1 max-w-prose text-small text-fg-secondary">
            Living reference for tokens and primitives (Phase A). Development only. Everything here is the real component, not a mock-up; no product data is shown.
          </p>
        </header>
        ...
        <Block id="d-space" title="Spacing, radius, elevation">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            {[['badge 4', 'rounded-badge'], ['control 6', 'rounded-control'], ['media 8', 'rounded-media'], ['panel 12', 'rounded-panel']].map(([n, c]) => (
