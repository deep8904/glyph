...
export default async function NewDevlogPage({
  ...
  return (
    <PlasmaShell>
      <div className="flex items-center gap-3 px-5 py-5 sm:px-8 sm:py-6 md:px-10 border-b border-gray-100/50 flex-wrap">
        ...
        <span className="text-gray-300">/</span>
        <span className="font-mono text-[10px] uppercase tracking-widest text-gray-400 truncate max-w-40">
          {project.title}
        </span>
        <span className="text-gray-300">/</span>
        <span className="font-mono text-[10px] uppercase tracking-widest text-gray-400">New Devlog</span>
      </div>

      <div className="flex-1 px-5 py-8 sm:px-8 md:px-10">
        <h1 className="text-2xl font-light tracking-tighter text-gray-900 mb-1">Write a Devlog</h1>
